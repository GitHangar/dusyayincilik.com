...
clear: both;
text-align: right;
background: url("./_img/_cs/phpbb_logo.gif") top left no-repeat;
height: 49px;
font-size: 0.85em;
margin-bottom: 10px;
}
...
.status2, .status6, .status7, .status8, .status9, .status10, .status12 {
background-color: #BC2A4D; 
}
...
a.vitrinler:hover  { font-family:Verdana; font-size:10px; text-decoration:underline; color:#000000; }
